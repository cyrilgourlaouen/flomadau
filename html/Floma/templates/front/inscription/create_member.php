<main id="inscription_main"> 
    <div id="form_main">
        ...
        <form method="post" enctype="multipart/form-data" action="inscription_membre.php" id="inscription_membre">
            ...
            <div class="groupe">
                <div>
                    ...
                    </html>           <input name="pseudo" id="pseudo" type="text" placeholder="Le voyageur" required></input>
            ...
            <div class="groupe">
                <div>
                    ...
                    </html>           <input name="city" id="city" type="text" placeholder="Trifouillis-les-bigorneaux" required></input>
        ...
        <h4>Si vous avez déjà un compte <a href="https://www.google.com/url?sa=t&source=web&rct=j&opi=89978449&url=https://www.youtube.com/watch%3Fv%3DdQw4w9WgXcQ&ved=2ahUKEwjroem03KeNAxXhRaQEHWjSHfwQwqsBegQIDRAG&usg=AOvVaw0aHtehaphMhOCAkCydRLZU">connectez-vous</a></h3>
