        ...
        <div class="data-container">
            <form method="POST" class="personal-data">
                ...
                <div class="lines-container">
                    <div class="lines">
                        <h3>Prénom*</h3>
                        <input class="input" type="text" name="firstname" value="<?= htmlspecialchars($user['firstname']) ?>" disabled
                            required>
                    </div>
                    <div class="lines">
                        <h3>Nom*</h3>
                ...
                <div class="lines-container">
                    <div class="lines">
                        <h3>Pseudonyme*</h3>
                        <input class="input" type="text" name="pseudo" value="<?= htmlspecialchars($user['pseudo']) ?>" disabled
                            required>
                    </div>
                    <div class="lines">
                ...
                <div class="lines-container">
                    <div class="lines , email">
                        ...
                        <input class="input" type="email" name="email" value="<?= htmlspecialchars($user['email']) ?>" disabled
                            required>
                    </div>
                </div>
